...
- All thirty-seven locations have a dedicated evidence-led scene and six bespoke movable objects, but the painted-background upgrade is not complete. Twenty-nine locations currently use optimized painted backgrounds. Eight still use their detailed custom SVG scenes and remain on the painted-art backlog: Singapore ZF1220, Praslin YR106, São Tomé JU2484, Pohnpei QG4739, Queensland QG2904, Saint-Benoît JU1373 (Réunion), Nouragues JU1428 and Manaus region JU1976. Do not describe these eight as visually upgraded to the painted standard until each receives a preserved source painting, an optimized runtime derivative and fresh responsive interaction QA.
