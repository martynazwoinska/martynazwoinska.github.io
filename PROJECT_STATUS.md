...
- Homepage behaviour and translations are separated into `home.js` and `home-i18n.js`. The Contact photograph is inset beside the address and action cluster on wider screens instead of being anchored to the section’s far edge; its established centred mobile placement remains unchanged.
