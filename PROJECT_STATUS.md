...
- Bristol N2 is the first location completed under the higher-detail, one-location-at-a-time art workflow. Its dedicated scene distinguishes the recorded compost microhabitat and urban garden from the regional Avon Gorge and Clifton Suspension Bridge context. Its six movable laboratory objects use bespoke primary and companion geometry above the older N2 detail benchmark.
- `docs/game-of-worms-location-research/bristol-n2.md` records Bristol’s collection evidence, regional landscape and landmark references, accessory evidence, illustration contract and interaction acceptance tests. Every later location requires an equivalent dossier before revision.
...
1. Revise the remaining 36 Game locations one at a time. For each location, research the collection area, landscape, landmarks and plausible local or scientific objects; write its dossier; then complete and review its landscape and three accessory pairs before starting another location.
