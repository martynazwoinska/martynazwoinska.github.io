...
- The Bristol N2 scene uses a River Avon channel that opens beneath the bridge and widens continuously toward the foreground, with restrained level ripples. Its urban-side buildings are one quiet, attached terrace silhouette set beyond the bridge tower rather than repeated pitched-house symbols.
