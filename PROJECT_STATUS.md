...
1. Revise the remaining 29 Game locations one at a time. For each location, research the collection area, landscape, landmarks and plausible local or scientific objects; write its dossier; then complete and review its landscape and three accessory pairs before starting another location.
