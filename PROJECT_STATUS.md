...
- The Bristol N2 scene uses a narrow blue River Avon channel inside a broader muted brown low-tide riverbed, with blue remaining the dominant river colour. Both river layers end just below the large foreground worm's tail and neither continues into the lower scene. The separate side garden grounds never join across the river as a mound. The bridge provides the Bristol urban silhouette at small sizes; the competing generic terrace symbols are intentionally omitted.
