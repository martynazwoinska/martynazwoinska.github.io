...
- The Bristol N2 scene uses a muted low-tide River Avon bed with a narrower, gently bending water channel and two sparse highlights. The lower reach passes behind the near garden edge instead of continuing as a central road-like wedge to the bottom of the frame. The bridge provides the Bristol urban silhouette at small sizes; the competing generic terrace symbols are intentionally omitted.
