...
- The desktop homepage header includes a restrained `MZ` monogram that is omitted from compact navigation. Botanical section dividers are reserved for the major Research, Beyond Research and Contact chapter changes; the Current work, Publications, Collaborators and Students subsections rely on headings and whitespace. Collaborators and students share one unnumbered, flat folio-list treatment with internal neutral hairlines only. Research interests retain flat static topic cards, while Beyond Research and Contact retain their functional card treatments. Publication disclosure remains a pill control, but its external resource destinations are quiet editorial links. The chatbot introduction and quotation use the original editorial flow, with a fine gold rule beside the quotation, and the footer contains only the localized copyright affiliation line.
