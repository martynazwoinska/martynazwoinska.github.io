...
- Game of Worms accessories can be repositioned by pointer, touch, or keyboard; positions are kept separately for each species and location during the session, and Home resets the selected accessory. The random `Surprise me` control has been removed.
