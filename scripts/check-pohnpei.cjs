...
(async()=>{
  ...
  assert.equal(sledFrame(7300).board,0);assert.equal(sledFrame(7300).travel,0);assert(sledFrame(7300).done);
  ...
  assert(play.includes('translate(225,180).rotate(f.turn*.9).translate(-225,-180)'));
