(function () {
  ...
  window.CABINET_OBJECTS = Object.freeze([
    ...
    chocolate('small-green-wrapper', 'Zotter Labooko Dominican Republic Milk, 40%', 'confirmed', [56.90, 16.58, 2.93, 5.99], {
    ...
    chocolate('omnom-craft-madagascar-66', 'Omnom Craft Madagascar, 66%', 'confirmed', [60.35, 15.54, 13.87, 9.03], {
    ...
    chocolate('amedei-porcelana-70', 'Amedei Porcelana, 70%', 'confirmed', [74.41, 15.63, 7.88, 18.23], {
      maker: 'Amedei', cacao: '70%', link: 'https://amedei.it/en/products/porcelana', linkLabel: 'View the official product page'
    }),
    chocolate('pink-sea-salt-wrapper', 'Pump Street Sourdough & Sea Salt, 66%', 'confirmed', [30.99, 24.65, 5.21, 10.33], {
    ...
    chocolate('pink-madagascar-wrapper', 'Pump Street Madagascar Ambanja, 72%', 'confirmed', [36.46, 25.69, 4.82, 9.29], {
    ...
    chocolate('small-wrapper-middle', 'Zotter Labooko Tanzania Milk, 50%', 'confirmed', [58.53, 25.09, 2.93, 6.42], {
    ...
    chocolate('uganda-horizontal-wrapper', 'Zotter Labooko Uganda, 70%', 'confirmed', [62.89, 25.00, 11.85, 6.77], {
    ...
    chocolate('wild-schokolade-chimore-65', 'Vild Chokolade Chimoré, 65%', 'confirmed', [71.16, 34.11, 8.07, 20.31], {
    ...
    chocolate('aroko-chuao-amazonas-70', 'Aroko Chuao, Aragua Venezuela, 70%', 'confirmed', [47.59, 53.56, 13.22, 18.58], {
    ...
    chocolate('black-cherry-70', 'Ocelot Black Cherry, 70%', 'confirmed', [61.00, 48.61, 8.40, 16.75], {
      maker: 'Ocelot', cacao: '70%', link: 'https://www.ocelotchocolate.com/products/black-cherry', linkLabel: 'View the official product page'
    }),
    chocolate('marou-green', 'Marou Bến Tre, 78%', 'confirmed', [71.48, 55.12, 5.53, 16.41], {
    ...
    chocolate('firetree-solomon-islands', 'Firetree Guadalcanal, Solomon Islands, 69%', 'confirmed', [78.97, 54.51, 6.12, 17.01], {
    ...
    chocolate('paradai-chanthaburi-yellow', 'Paradai Chanthaburi, 70%', 'confirmed', [11.33, 81.04, 14.78, 13.54], {
    ...
    chocolate('bonnat-java', 'Bonnat Java milk chocolate, 65%', 'confirmed', [46.22, 75.17, 15.23, 10.94], {
