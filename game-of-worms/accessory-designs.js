...
import { drawAraucaniaWork, araucaniaLayouts } from "./araucania-art.js?v=20260923-four-scenes-1";
import { drawDoisRios, doisRiosLayouts } from "./dois-rios-art.js?v=20260908-dois-rios-1";
import { drawNambucca, nambuccaLayouts } from "./nambucca-art.js?v=20260921-motion-1";
...
function drawNamedAccessory(group, item, companion) {
  ...
  if (drawOrsayArt(group, item, companion)) return true;
