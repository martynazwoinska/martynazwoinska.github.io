...
import { auditEnvironmentCompositions, getEnvironmentProfile, renderEnvironmentScene } from "./environment-scenes.js?v=20260729-35";
...
const species = [
  ...
  },
  {
    ...
    locations: [
      ...
      { name: "Taipei, Taiwan · BRC20390", coordinates: [121.576542, 25.027105], source: "CaeNDR BRC20390 isotype record", style: "rainforest", strain: "BRC20390", history: "BRC20390 is the reference strain of an eleven-strain C. briggsae isotype sampled by J. Wang in forest at 174 m in Taipei on 4 October 2015. CaeNDR records the substrate, substrate temperature, ambient temperature and ambient humidity as not determined; its two linked source photographs document dark, irregular sample fragments without establishing their biological identity." },
      { name: "Kerala, India · JU1337", coordinates: [77.075, 8.32], source: "CaeNDR JU1337 isotype record", style: "rainforest", strain: "JU1337", history: "JU1337, also known as 1K1, is a singleton C. briggsae reference isotype sampled by M.-A. Félix from broad rotting plant material in agricultural land at 34 m near Poovar, Kerala, on 16 December 2007. CaeNDR records the substrate temperature, ambient temperature and ambient humidity as not determined; the plant species, crop and exact property are unreported." },
      { name: "Kauaʻi, Hawaiʻi · QG130", coordinates: [-159.5829, 22.2202], source: "CaeNDR QG130 isotype record", style: "kauai", strain: "QG130", history: "QG130 is the reference strain of a three-strain C. briggsae isotype sampled by M. Rockman from broad rotting plant material in forest at 11 m on Kauaʻi on 2 August 2009. CaeNDR records the substrate temperature, ambient temperature and ambient humidity as not determined; the fruit identity and exact collection-patch view are unreported." },
      { name: "Réunion Island · JU1375", coordinates: [55.6885, -21.0469], source: "CaeNDR JU1375 isotype record", style: "ocean", strain: "JU1375", history: "JU1375, also known as R8N1, is a singleton C. briggsae reference isotype sampled by V. Robert from a mollusk in agricultural land at 123 m on Réunion on 31 December 2007. CaeNDR records the substrate temperature, ambient temperature and ambient humidity as not determined; the mollusk species, crop and exact collection-patch view are unreported." },
      { name: "Orsay, France · JU2518", coordinates: [2.1725, 48.7015], source: "CaeNDR JU2518 isotype record", style: "field", strain: "JU2518", history: "JU2518 is a singleton C. briggsae reference isotype sampled and isolated by L. Frezal from a rotten apple in a rural garden at 65 m in Orsay on 6 September 2012. CaeNDR records Santeuil virus as the associated organism and the environmental measurements as not determined; the apple cultivar, property and exact collection-patch view are unreported." },
      { name: "Dois Rios, Ilha Grande, Brazil · EG5612", coordinates: [-44.19, -23.18], source: "CaeNDR EG5612 isotype record", style: "rainforest", strain: "EG5612", history: "EG5612 is the reference strain of a two-strain C. briggsae isotype sampled and isolated by M. Ailion from rotten jackfruit in forest at 3 m near Dois Rios, Ilha Grande, on 29 April 2009. Many animals emerged, but the strain began from one L4. Its paired strain was recorded from a rotten red flower; both samples travelled in the same bag and may not be independent. Test crosses produced no cross-progeny with C. elegans males but did with C. briggsae males." },
      { name: "Nambucca Heads, New South Wales · QG2814", coordinates: [153.0090333, -30.6445167], source: "CaeNDR QG2814 isotype record", style: "rainforest", strain: "QG2814", history: "QG2814 is the reference strain of a two-strain C. briggsae isotype sampled and isolated by M. Rockman from rotting flowers on the ground in the rainforest garden behind Marcel Towers at 21 m on 25 March 2017. Both strains came from the same flower sample. The reference began from one L4 on the first of two plates five days later; the note records identification by 18S sequencing." }
    ]
  },
  {
    id: "elegans",
  ...
  },
  {
    ...
    locations: [
      ...
      { name: "São Tomé · JU2484", coordinates: [6.6, 0.2], source: "Félix Lab", style: "rainforest", strain: "JU2484", history: "JU2484, formerly Goy1, is an isofemale C. nigoni line sampled by Rémy Froissart on 28 February 2013 from rotten unidentified fruit on the ground in forest on São Tomé and isolated by Lise Frézal. Its exact forest site, elevation and fruit identity are unreported." },
      { name: "Mahahual, Mexico · JU2617", coordinates: [-87.71, 18.72], source: "Worldwide Worms/Félix JU2617 record", style: "farm", strain: "JU2617", history: "JU2617, previously Y2.1, is an isofemale C. nigoni strain sampled by Luc Barre from a rotting-fruit heap, mostly oranges, in a rural garden in Mahahual, Quintana Roo, and isolated by M.-A. Félix. Worldwide Worms records test-cross identification. Its structured date is 31 December 2013, while the collection note says January 2014, so no single exact collection date is asserted here." },
      { name: "Mauritius · JU2909", coordinates: [57.4061, -20.2914], source: "Worldwide Worms/Félix JU2909 record", style: "rainforest", strain: "JU2909", history: "JU2909, previously M2.3, is an isofemale C. nigoni strain sampled by Henrique Teotonio from rotting fruit on the ground at Casela Nature Park, Cascavelle, Mauritius, in late December 2015 and isolated by M.-A. Félix. The anonymous fruit was described as about 8 cm long and oval with a large woody nut. The line began with an L4 female and a male; Worldwide Worms records test-cross identification and says JU2909 came from the same sample as C. briggsae JU2910, without establishing one shared individual fruit." },
      { name: "Ho Chi Minh City · JU4356", coordinates: [106.6939439, 10.7742239], source: "Félix Lab Worldwide Worms: JU4356", style: "rainforest", strain: "JU4356", history: "JU4356, formerly HCM1, is an isofemale wild C. nigoni isolate sampled by Mirko Francesconi from one rotting carambola on the ground in an urban garden in Ho Chi Minh City on 30 August 2022 and isolated by M.-A. Félix. ITS2 pointed to C. nigoni, and the record says crosses with JU1325 worked in both directions. The exact property, source tree, elevation and collection weather are unreported." },
      { name: "Lombok, Indonesia · HPT26", coordinates: [116.239667, -8.527466], source: "Devi et al. 2025", style: "rainforest", strain: "HPT26", history: "HPT26 (L14.1) is an isofemale C. nigoni strain from rotting Ficus fruits on the ground at 293 m in Lingsar, Lombok, sampled on 4 May 2024 in survey habitat recorded as “forest with some culture.” Devi et al. report that the Lombok samples were put on plates on 8 May; the source identifies field and isolation teams but not an individual collector or isolator for HPT26." }
    ]
  },
  {
    id: "wallacei",
  ...
  },
  {
    ...
    locations: [
      ...
      { name: "La Selva, Costa Rica", coordinates: [-84.01138, 10.43082], source: "CaeNDR QG3845 isotype record", style: "rainforest", strain: "QG3845", history: "QG3845 is CaeNDR’s isotype-reference C. tropicalis strain from a rotting unidentified brown fruit in La Selva forest at 65 m. A. Martel sampled and isolated it on 2 July 2019; the recorded substrate temperature was 26.5 °C. The 2019 survey recovered nematodes by Baermann funnel, and established cultures remained on NGM plates at La Selva for about six months before transport to New York." },
      { name: "Guadeloupe · NIC203", coordinates: [-61.6262, 16.0459], source: "CaeNDR NIC203 isotype record", style: "rainforest", strain: "NIC203", history: "This marker represents NIC203, an isotype-reference C. tropicalis strain previously called G-H1a1. N. Poullet sampled and isolated it from a rotting Etlingera elatior flower in forest at 420 m at the Third Carbet Falls locality on 4 September 2011; mating and ITS2 supported its identification. Later laboratory crosses with EG6180 helped reveal three maternal-effect toxin–antidote systems in NIC203." },
      ...
      { name: "Oʻahu, Hawaiʻi · ECA789", coordinates: [-157.799786, 21.336056], source: "CaeNDR ECA789 isotype record", style: "rainforest", strain: "ECA789", history: "ECA789 is an isotype-reference C. tropicalis strain previously called S-05097. E. Andersen sampled and isolated it on 4 August 2017 from a rotting flower on the ground along Mānoa Falls Trail at 157 m. ITS2 supported its identification. CaeNDR records substrate and ambient temperatures of 22.9 °C, ambient humidity of 93.7%, and the note “C-0085 collection plate from Hawaii sampling trip.”" },
      { name: "Kauaʻi, Hawaiʻi · QG131", coordinates: [-159.4764, 22.22955], source: "CaeNDR QG131 isotype record", style: "ocean", strain: "QG131", history: "QG131 is a sequenced, distributable C. tropicalis isotype reference. M. Rockman sampled and isolated it on 3 August 2009 from two rotten pandanus fruits beneath a pandanus tree along the trail down to Sealodge Beach, Princeville, at 10 m. CaeNDR records mating as its identification method. The culture note records agar isolation, tube transport on 8 August, transfer to NGM with OP50 on 14 August, and freezing without bleaching on 23 August." },
      { name: "New Taipei City, Taiwan · NIC1648", coordinates: [121.82753, 25.06574], source: "CaeNDR NIC1648 isotype record", style: "rainforest", strain: "NIC1648", history: "NIC1648, previously 3b, was sampled by C. Gosse on 17 October 2017 from small 10–15 mm figs on and beside concrete stairs descending toward Menghuan Falls in Ruifang District, New Taipei City, and isolated by C. Braendle. ITS2 supported its identification. The strain record also says it was not bleached and notes many males, without a count or inferred cause." },
      ...
      { name: "Saint-Benoît, Réunion · JU1373", coordinates: [55.6885, -21.0473], source: "CaeNDR JU1373 isotype record", style: "farm", strain: "JU1373", history: "JU1373, previously R4D1 and Caenorhabditis sp. 11, is the type isolate of C. tropicalis in the 2014 species description; CaeNDR lists the same line as its isotype-reference strain. The structured sampler field names V. Robert, while the free-text collection note credits Valérie Robert and Loïc Sablé; M.-A. Félix isolated the line. CaeNDR records 129 m elevation; its structured date is 31 December 2007, whereas the collection note says early January 2008 and qualitatively notes a hermaphrodite and a highly proliferating population. No exact worm count, proliferation rate, temperature, humidity, associated organism or collection-patch geometry is reported." }
    ]
  }
];
