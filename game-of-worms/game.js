...
const species = [
  ...
  },
  {
    ...
    locations: [
      ...
      { name: "Saint-Benoît, Réunion · JU1373", coordinates: [55.6885, -21.0473], source: "CaeNDR JU1373 isotype record", style: "farm", strain: "JU1373", history: "JU1373, previously R4D1, is the type isolate of C. tropicalis and CaeNDR isotype-reference strain, isolated by M.-A. Félix from rotting torch-ginger flowers in agricultural land at Saint-Benoît, Réunion. The structured date is 31 December 2007 while the collection note says early January 2008." }
    ]
  }
];
