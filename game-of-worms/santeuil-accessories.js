...
function uniform(g, small) {
  ...
  const cap = el(g,"g",{transform:small?"translate(326 32) rotate(25)":"translate(326 31) rotate(26)"});
...
export function drawSanteuilRefinement(group, item, companion) {
  const render = {
    ...
    "santeuil-cylinder-organ-instrument": organ,
    "santeuil-hogweed-locomotive": locomotive
  }[item.family];
