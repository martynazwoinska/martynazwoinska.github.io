...
Marine Ink is the first-visit default when no theme preference has been stored. A visitor’s explicit light or dark choice is retained for later visits. The explicit `data-theme="light"` theme restores the light values.
