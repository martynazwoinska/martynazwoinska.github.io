...
| **Photo** | Embedded in `index.html` | Send a replacement headshot if you want me to swap it |
...
3. A social-preview image for richer link previews on Bluesky, LinkedIn, and search results
